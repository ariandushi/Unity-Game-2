...
public class GroundCube : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        normalColor = myRend.material;//getting the color of the ground cube (green color)
    ...
    public void HandleSelection()//a better name would be ToggleSelection()
    {
        ...
        myRend.material = currentColor;//setting the MeshRenderer's material color to whatever the currentColor is
    }
